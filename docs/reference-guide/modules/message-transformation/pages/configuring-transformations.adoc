...
This is the incremental approach Greg Young recommends for versioning in event-sourced systems: each step stays small, isolated, and easy to reason about, and adding a new version means appending one more transformation while the chain keeps composing the steps for you.
====
...
Copy it into your own project, or assert on the built transformation however you prefer.
