...
/**
 * Event message transformations that lift historic shapes to the current shape at
 * read time. Each transformation is a self-contained class; the chain is composed in
