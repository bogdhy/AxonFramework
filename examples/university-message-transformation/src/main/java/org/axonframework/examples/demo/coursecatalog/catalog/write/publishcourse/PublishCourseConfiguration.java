...
/**
 * Wires the publish-course command slice into an {@link EventSourcingConfigurer}.
 */
public final class PublishCourseConfiguration {

    private PublishCourseConfiguration() {
    }
    ...
    public static EventSourcingConfigurer configure(EventSourcingConfigurer configurer) {
        var stateEntity = EventSourcedEntityModule
                .autodetected(CourseId.class, PublishCourseCommandHandler.State.class);

        var commandHandling = CommandHandlingModule
                .named("PublishCourse")
                .commandHandlers()
                .autodetectedCommandHandlingComponent(c -> new PublishCourseCommandHandler());
