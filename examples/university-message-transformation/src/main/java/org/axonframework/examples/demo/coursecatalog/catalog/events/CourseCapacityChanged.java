...
/**
 * A course's capacity range was updated after publication.
 *
 * @param courseId the course whose capacity changed
 * @param newRange the new capacity range
 */
@Event(namespace = CourseCatalogMessageNames.NAMESPACE, name = "CourseCapacityChanged", version = "1.0.0")
